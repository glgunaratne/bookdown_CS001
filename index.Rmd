...
**Deliver the first base platform of a coupled hydrodynamic - water quality model for Cockburn Sound and surrounding waters – termed the Cycle I model in the head agreement. The model developed under this agreement [@WAMSI2022] will be available for use by researchers and industry for scenario assessment, and further research and development.**
...
```{r CS_studysite, fig.cap='Cockburn Sound and associated waters', out.width='80%', fig.asp=.75, fig.align='center', fig.alt='Fundamental to assessing the impacts of future changes within Cockburn Sound and associated waters'}
